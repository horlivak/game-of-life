...
use ECSPrefix202601\Symplify\EasyParallel\Contract\SerializableInterface;
final class FileDiff implements SerializableInterface
{
     ...
     * @return $this
     */
    public static function decode(array $json) : \ECSPrefix202601\Symplify\EasyParallel\Contract\SerializableInterface
    {
