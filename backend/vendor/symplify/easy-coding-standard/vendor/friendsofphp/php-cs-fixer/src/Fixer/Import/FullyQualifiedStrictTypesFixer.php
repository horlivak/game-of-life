...
use ECSPrefix202601\Foo\Bar;
use ECSPrefix202601\Foo\Bar\Baz;
use ECSPrefix202601\Foo\OtherClass;
use ECSPrefix202601\Foo\SomeContract;
use ECSPrefix202601\Foo\SomeException;
/**
* @see \Foo\Bar\Baz
*/
class SomeClass extends \ECSPrefix202601\Foo\OtherClass implements \ECSPrefix202601\Foo\SomeContract
{
    /**
    * @var \Foo\Bar\Baz
    */
    ...
    */
    ...
    public function doX(\ECSPrefix202601\Foo\Bar $foo, \Exception $e) : \ECSPrefix202601\Foo\Bar\Baz
    {
        try {
        } catch (\ECSPrefix202601\Foo\SomeException $e) {
        }
    }
}
/**
* @see \Foo\Bar\Baz
*/
\class_alias('ECSPrefix202601\\SomeClass', 'SomeClass', \false);
...
class SomeClass
{
    public function doY(Foo\NotImported $u, \ECSPrefix202601\Foo\NotImported $v)
    {
    }
}
\class_alias('ECSPrefix202601\\SomeClass', 'SomeClass', \false);
...
use ECSPrefix202601\Foo\A;
try {
    foo();
} catch (\Exception|\ECSPrefix202601\Foo\A $e) {
}
namespace ECSPrefix202601\Foo\Bar;

class SomeClass implements \ECSPrefix202601\Foo\Bar\Baz
{
}
...
namespace ECSPrefix202601\Foo\Test;

class Foo extends \ECSPrefix202601\Other\BaseClass implements \ECSPrefix202601\Other\Interface1, \ECSPrefix202601\Other\Interface2
{
    /** @var \Other\PropertyPhpDoc */
    private $array;
    public function __construct(\ECSPrefix202601\Other\FunctionArgument $arg)
    {
    }
    public function foo() : \ECSPrefix202601\Other\FunctionReturnType
    {
        try {
            \ECSPrefix202601\Other\StaticFunctionCall::bar();
        } catch (\ECSPrefix202601\Other\CaughtThrowable $e) {
        }
    }
}
