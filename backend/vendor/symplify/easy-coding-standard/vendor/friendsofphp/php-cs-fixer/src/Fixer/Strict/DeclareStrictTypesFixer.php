...
final class DeclareStrictTypesFixer extends AbstractFixer implements ConfigurableFixerInterface, WhitespacesAwareFixerInterface
{
    ...
    {
        return new FixerDefinition('Force strict types declaration in all files.', [new CodeSample("<?php\n"), new CodeSample("<?php\ndeclare(Strict_Types=0);\n", ['preserve_existing_declaration' => \false]), new CodeSample("<?php\ndeclare(Strict_Types=0);\n", ['preserve_existing_declaration' => \true])], null, 'Forcing strict types will stop non strict code from working.');
    }
    /**
     * {@inheritdoc}
     *
    ...
    {
        return new FixerConfigurationResolver([(new FixerOptionBuilder('preserve_existing_declaration', 'Whether existing strict_types=? should be preserved and not overridden.'))->setAllowedTypes(['bool'])->setDefault(\false)->getOption()]);
    }
