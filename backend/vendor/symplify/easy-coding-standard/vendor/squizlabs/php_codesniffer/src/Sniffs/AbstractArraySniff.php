...
abstract class AbstractArraySniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     * @return void
     */
    protected abstract function processSingleLineArray(File $phpcsFile, int $stackPtr, int $arrayStart, int $arrayEnd, array $indices);
    /**
     ...
     * @return void
     */
    protected abstract function processMultiLineArray(File $phpcsFile, int $stackPtr, int $arrayStart, int $arrayEnd, array $indices);
}
