...
abstract class AbstractScopeSniff implements \PHP_CodeSniffer\Sniffs\Sniff
{
     ...
     */
    public final function process(File $phpcsFile, int $stackPtr)
    {
     ...
     *                  the rest of the file.
     */
    protected abstract function processTokenWithinScope(File $phpcsFile, int $stackPtr, int $currScope);
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processTokenOutsideScope(File $phpcsFile, int $stackPtr);
}
