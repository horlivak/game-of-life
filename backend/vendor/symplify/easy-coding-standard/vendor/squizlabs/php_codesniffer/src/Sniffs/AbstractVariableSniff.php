...
abstract class AbstractVariableSniff extends \PHP_CodeSniffer\Sniffs\AbstractScopeSniff
{
     ...
     */
    protected final function processTokenWithinScope(File $phpcsFile, int $stackPtr, int $currScope)
    {
     ...
     *                  the rest of the file.
     */
    protected final function processTokenOutsideScope(File $phpcsFile, int $stackPtr)
    {
        $tokens = $phpcsFile->getTokens();
     ...
     *                  the rest of the file.
     */
    protected abstract function processMemberVar(File $phpcsFile, int $stackPtr);
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processVariable(File $phpcsFile, int $stackPtr);
    /**
     ...
     *                  the rest of the file.
     */
    protected abstract function processVariableInString(File $phpcsFile, int $stackPtr);
}
