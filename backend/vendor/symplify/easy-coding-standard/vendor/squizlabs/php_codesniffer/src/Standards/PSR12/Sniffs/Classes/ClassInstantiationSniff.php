...
class ClassInstantiationSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, int $stackPtr)
    {
        ...
        $allowed += [\T_SELF => \T_SELF, \T_STATIC => \T_STATIC, \T_PARENT => \T_PARENT, \T_VARIABLE => \T_VARIABLE, \T_DOLLAR => \T_DOLLAR, \T_OBJECT_OPERATOR => \T_OBJECT_OPERATOR, \T_NULLSAFE_OBJECT_OPERATOR => \T_NULLSAFE_OBJECT_OPERATOR, \T_DOUBLE_COLON => \T_DOUBLE_COLON];
        ...
        if ($fix === \true) {
            $prev = $phpcsFile->findPrevious(Tokens::EMPTY_TOKENS, $classNameEnd - 1, null, \true);
