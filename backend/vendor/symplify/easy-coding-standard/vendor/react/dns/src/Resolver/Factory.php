...
namespace ECSPrefix202601\React\Dns\Resolver;

use ECSPrefix202601\React\Cache\ArrayCache;
use ECSPrefix202601\React\Cache\CacheInterface;
use ECSPrefix202601\React\Dns\Config\Config;
use ECSPrefix202601\React\Dns\Config\HostsFile;
use ECSPrefix202601\React\Dns\Query\CachingExecutor;
use ECSPrefix202601\React\Dns\Query\CoopExecutor;
use ECSPrefix202601\React\Dns\Query\ExecutorInterface;
use ECSPrefix202601\React\Dns\Query\FallbackExecutor;
use ECSPrefix202601\React\Dns\Query\HostsFileExecutor;
use ECSPrefix202601\React\Dns\Query\RetryExecutor;
use ECSPrefix202601\React\Dns\Query\SelectiveTransportExecutor;
use ECSPrefix202601\React\Dns\Query\TcpTransportExecutor;
use ECSPrefix202601\React\Dns\Query\TimeoutExecutor;
use ECSPrefix202601\React\Dns\Query\UdpTransportExecutor;
use ECSPrefix202601\React\EventLoop\Loop;
use ECSPrefix202601\React\EventLoop\LoopInterface;
final class Factory
{
    /**
