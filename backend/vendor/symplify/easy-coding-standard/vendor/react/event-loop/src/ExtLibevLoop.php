...
namespace ECSPrefix202601\React\EventLoop;

use BadMethodCallException;
use ECSPrefix202601\libev\EventLoop;
use ECSPrefix202601\libev\IOEvent;
use ECSPrefix202601\libev\SignalEvent;
use ECSPrefix202601\libev\TimerEvent;
use ECSPrefix202601\React\EventLoop\Tick\FutureTickQueue;
use ECSPrefix202601\React\EventLoop\Timer\Timer;
...
final class ExtLibevLoop implements LoopInterface
{
    ...
    {
        if (!\class_exists('ECSPrefix202601\\libev\\EventLoop', \false)) {
